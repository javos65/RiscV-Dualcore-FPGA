...
// Netlist written on Thu Jun 27 16:44:31 2024
...
//
// Verilog Description of module cpu1
// module wrapper written out since it is a black-box. 
//

//

module cpu1 (clk_i, rst_n_i, system_resetn_o, irq1_i, irq0_i, timer_irq_o, 
            ahbl_m_instr_haddr_o, ahbl_m_instr_hwrite_o, ahbl_m_instr_hsize_o, 
            ahbl_m_instr_hburst_o, ahbl_m_instr_hprot_o, ahbl_m_instr_htrans_o, 
            ahbl_m_instr_hmastlock_o, ahbl_m_instr_hwdata_o, ahbl_m_instr_hrdata_i, 
            ahbl_m_instr_hready_i, ahbl_m_instr_hresp_i, ahbl_m_data_haddr_o, 
            ahbl_m_data_hwrite_o, ahbl_m_data_hsize_o, ahbl_m_data_hburst_o, 
            ahbl_m_data_hprot_o, ahbl_m_data_htrans_o, ahbl_m_data_hmastlock_o, 
            ahbl_m_data_hwdata_o, ahbl_m_data_hrdata_i, ahbl_m_data_hready_i, 
            ahbl_m_data_hresp_i) /* synthesis cpe_box=1 */ ;
    input clk_i;
    input rst_n_i;
