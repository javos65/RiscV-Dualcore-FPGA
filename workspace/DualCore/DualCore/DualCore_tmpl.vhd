...
component DualCore is
    port (led_g: inout std_logic_vector(7 downto 0);
        user_b: in std_logic_vector(7 downto 0);
        rstn_i: in std_logic;
        rxd_i: in std_logic;
        txd_o: out std_logic
    );
    
end component DualCore;
_inst: DualCore port map (rxd_i => __,
                          txd_o => __,
                          led_g => __,
                          user_b => __,
                          rstn_i => __);
